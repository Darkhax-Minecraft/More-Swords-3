...
public class Items {
	...
	public static Item swordDawmStar = new ItemCoreSword(11111, EnumToolMaterial.EMERALD).setUnlocalizedName("msm.dawnstar").setTextureName("moreswords:sword_dawnStar");
