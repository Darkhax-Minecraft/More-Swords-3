...
public class SwordItems {
	...
	public static Item swordDawmStar = new ItemBaseSword(
			EnumMoreSwords.DAWNSTAR.swordName);
	...
	/**
	 * Registers an item as a sword. Initialized the item, adds it to the
	 * GameRegistry and adds it to the private sword list.
	 * 
	 * @param item
