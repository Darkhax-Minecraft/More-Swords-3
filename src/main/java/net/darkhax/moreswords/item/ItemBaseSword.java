...
public class ItemBaseSword extends ItemSword {
	...
	public static Item.ToolMaterial generateToolMaterials(String swordName) {
		...
		Item.ToolMaterial material = EnumHelper.addToolMaterial(swordName,
				sword.swordHarvestLevel, sword.swordDurability,
				sword.swordEfficiency, sword.swordDamage - 4,
				sword.swordEnchantability);
	...
	public static class ItemGlowSword extends ItemBaseSword {
		...
		public void registerIcons(IIconRegister register) {
			...
			iconArray[0] = register.registerIcon("moreswords:"
					+ "sword_lux_off");
			iconArray[1] = register
					.registerIcon("moreswords:" + "sword_lux_on");
		}
		...
		public IIcon getIconIndex(ItemStack stack) {
			...
			if (stack != null) {
				...
				if (stackTag.hasKey("LightStatus")) {
					...
					IIcon icon = iconArray[stackTag.getBoolean("LightStatus") ? 1
							: 0];
					this.itemIcon = icon;
					return icon;
				}
