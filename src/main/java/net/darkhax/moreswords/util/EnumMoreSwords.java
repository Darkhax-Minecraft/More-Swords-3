...
public enum EnumMoreSwords {
	...
	DAWNSTAR("dawnStar", Config.damageDawnStar, Config.durabilityDawnStar, Config.enchantDawnStar, Config.harvestDawnStar, Config.efficientDawnStar, Config.repairDawnStar, Config.craftingDawnStar), VAMPIRIC("vampiric", Config.damageVampiric, Config.durabilityVampiric, Config.enchantVampiric, Config.harvestVampiric, Config.efficientVampiric, Config.repairVampiric, Config.craftingVampiric), GLADIOLUS("gladiolus", Config.damageGladiolus, Config.durabilityGladiolus, Config.enchantGladiolus, Config.harvestGladiolus, Config.efficientGladiolus, Config.repairGladiolus, Config.craftingGladiolus), DRACONIC("draconic", Config.damageDraconic, Config.durabilityDraconic, Config.enchantDraconic, Config.harvestDraconic, Config.efficientDraconic, Config.repairDraconic, Config.craftingDraconic), ENDER("ender", Config.damageEnder, Config.durabilityEnder, Config.enchantEnder, Config.harvestEnder, Config.efficientEnder, Config.repairEnder, Config.craftingEnder), CRYSTAL("crystal", Config.damageCrystal, Config.durabilityCrystal, Config.enchantCrystal, Config.harvestCrystal, Config.efficientCrystal, Config.repairCrystal, Config.craftingCrystal), GLACIAL("glacial", Config.damageGlacial, Config.durabilityGlacial, Config.enchantGlacial, Config.harvestGlacial, Config.efficientGlacial, Config.repairGlacial, Config.craftingGlacial), AETHER("aether", Config.damageAether, Config.durabilityAether, Config.enchantAether, Config.harvestAether, Config.efficientAether, Config.repairAether, Config.craftingAether), WITHER("wither", Config.damageWither, Config.durabilityWither, Config.enchantWither, Config.harvestWither, Config.efficientWither, Config.repairWither, Config.craftingWither), ADMIN("admin", Config.damageAdmin, Config.durabilityAdmin, Config.enchantAdmin, Config.harvestAdmin, Config.efficientAdmin, Config.repairAdmin, Config.craftingAdmin);

	/**
	 * @param repairMaterial
	 *            : name of the item used to repair the sword.
	 */
