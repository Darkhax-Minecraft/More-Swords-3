...
public class Utils {
	...
	/**
	 * General UUID used for all items in the game. This is used for all the
	 * stack uuids.
	 */
	 ...
	 * 
	 * @param stack
	 *            : ItemStack being used.
	 * @param amount
	 *            : The amount of health being set.
	 * @param type
	 *            : The operation type for the modifier.
	 */
	 ...
	 *            : ItemStack being used.
	 * @param amount
	 *            : The amount of damage being set.
	 * @param type
	 *            : The operation type for the modifier.
	 */
	...
	/**
	 * Sets an attribute on an ItemStack, this method is used by the other
	 * helper methods that provide certain elements such as the atb name. This
	 * method is sensitive to existing lists however it does not check to make
	 * sure that a stack has the ability to work with nbt. This method will drop
	 * the damamge value of an item down to 1 if it the damage modifier was not
	 * applied beforehand.
	 * 
	 * @param stack
	 *            : ItemStack to set values to.
	 * @param atbName
	 *            : The attribute name, this should be unlocalized.
	 * @param name
	 *            : The name of the attribute.
	 * @param amount
	 *            : The amount that this is being set to.
	 * @param operation
	 *            : 0-base 1-additive 2-multiplicative
	...
	/**
	 * Retrieves an attribute value from an ItemStack. This method does not
	 * check to make sure the ItemStack has valid tags, this should be done
	 * before hand. This method is used by the other helper methods to retrieve
	 * certain values.
	 * 
	 * @param stack
	 *            : The ItemStack being used to retrieve info from.
	 * @param atbName
	 *            : The name of the attribute.
	 */
