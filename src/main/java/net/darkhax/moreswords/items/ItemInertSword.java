...
public class ItemInertSword extends ItemSubType implements IVariant {
    ...
    public void addInformation (ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(I18n.format("misc.moreswords.progress", this.getSwordMaterial(stack).getAwakening().getAwakenProgress(PlayerUtils.getClientPlayer(), stack, StackUtils.prepareStackTag(stack))));
    }
