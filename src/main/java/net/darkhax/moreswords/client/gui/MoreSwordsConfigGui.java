...
public class MoreSwordsConfigGui extends GuiConfig {
	...
	public static List<IConfigElement> generateConfigList() {
		...
		String[] categories = { cfgh.general, cfgh.damage, cfgh.durability,
				cfgh.enchant, cfgh.harvest, cfgh.efficient, cfgh.repair,
				cfgh.crafting, cfgh.monster, cfgh.plugins, cfgh.ignite,
				cfgh.spark, cfgh.feast, cfgh.vitality, cfgh.venom, cfgh.absorb,
				cfgh.keenEdge, cfgh.scorn, cfgh.enderPulse, cfgh.enderAura,
				cfgh.greed, cfgh.wisdom, cfgh.frozen, cfgh.frost,
				cfgh.ascension, cfgh.ascension, cfgh.descension, cfgh.shadows,
