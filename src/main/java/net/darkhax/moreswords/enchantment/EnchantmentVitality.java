...
public class EnchantmentVitality extends EnchantmentBase {
    ...
    /**
     * Consumes 150 divided by the enchantment level out of the durability of the tool, gives the wielder
     * regeneration for 3 seconds multiplied by the enchantment level, gives a 4 heart health boost for 3
     * seconds multiplied by the enchantment level and a low level instant health boost for 0.05 seconds.
     */
    @SubscribeEvent
